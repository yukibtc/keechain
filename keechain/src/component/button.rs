...
use iced::widget::{self, button, Container};
use iced::{theme, Background, BorderRadius, Color, Length, Padding, Theme, Vector};
    ...
    Message: Clone + 'static,
{
    ...
    pub fn view(self) -> widget::Button<'static, Message> {
        ...
        let content = Container::new(Text::new(&self.text).view()).padding(Padding::new(5.0));
